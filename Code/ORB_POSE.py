...
def match_descriptors(desc1, desc2, ratio_thresh=0.75, max_matches=500, use_symmetry=True, debug=True, norm_type=cv2.NORM_HAMMING):
...
def estimate_pose_two_images(img1_bgr, img2_bgr, K,
    ...
    if feature_type == "ORB":
        ...
        raise ValueError(f"Unsupported feature type: {feature_type}. Supported: ORB, SIFT.")
    ...
    matches = match_descriptors(desc1, desc2,
                                ...
                                debug=debug, norm_type=norm_type)
